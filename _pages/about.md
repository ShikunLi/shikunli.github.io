...
- [Estimating Noise Transition Matrix with Label Correlations for Noisy Multi-Label Learning](https://openreview.net/forum?id=GwXrGy_vc8m). **Shikun Li**, Xiaobo Xia, Hansong Zhang, Yibing Zhan, Shiming Ge,  Tongliang Liu. **NeurIPS 2022**
- [Selective-Supervised Contrastive Learning with Noisy Labels](https://arxiv.org/abs/2203.04181). **Shikun Li**, Xiaobo Xia, Shiming Ge, Tongliang Liu. **CVPR 2022**
- [Student Network Learning via Evolutionary Knowledge Distillation](https://arxiv.org/pdf/2103.13811). Kangkai Zhang, Chunhui Zhang, **Shikun Li**, Dan Zeng, Shiming Ge.  **IEEE T-CSVT 2021**
- [Coupled-View Deep Classifier Learning from Multiple Noisy Annotators](https://ojs.aaai.org/index.php/AAAI/article/view/5898/5754). **Shikun Li**, Shiming Ge, Yingying Hua, Chunhui Zhang, Hao Wen, Tengfei Liu,  Weiqiang Wang. **AAAI 2020**
- [Cascaded Correlation Refinement for Robust Deep Tracking](https://ieeexplore.ieee.org/abstract/document/9069312/). Shiming Ge, Chunhui Zhang, **Shikun Li**, Dan Zeng,  Dacheng Tao. **IEEE T-NNLS 2020**
